...
#NEED TO WORK ON LOGIN_REQUIRED FEATURE...
...
def myinfo():
    ...
    return render_template("myinfo.html", username = username, userTOKEN = userTOKEN, userID = userID, userADDRESS = userADDRESS, userEMAIL = userEMAIL)
